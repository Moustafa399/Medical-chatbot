...
def train_and_save_model(path, words, classes, train_x, train_y):
    # Save all of our data structures
    pickle.dump({'words': words, 'classes': classes, 'train_x': train_x, 'train_y': train_y}, open("training_data", "wb"))

    # Training data
    pickle.dump(train_x, open(str(path) + 'train_x.pkl', 'wb'))
    pickle.dump(train_y, open(str(path) + 'train_y.pkl', 'wb'))
